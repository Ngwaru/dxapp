...
def process_input(question):
    ...
    after_rag_template = """Answer the question based only on the following context, include as much detail as possible from the following context:{context} Question:{question}"""
